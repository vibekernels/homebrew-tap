class ZstdVk < Formula
  ...
  url "https://github.com/vibekernels/zstd-vk-macos-arm64/archive/refs/tags/v0.1.0.tar.gz"
  ...
  bottle do
    root_url "https://github.com/vibekernels/zstd-vk-macos-arm64/releases/download/v0.1.0"
